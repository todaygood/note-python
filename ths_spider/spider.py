...
class crawl(object):
    ...
    def downloader(self, url, num_retries=3):
        ...
        headers_list = [{
            ...
            'Cookie': 'Hm_lvt_78c58f01938e4d85eaf619eae71b4ed1=1650063033; Hm_lpvt_78c58f01938e4d85eaf619eae71b4ed1=1650071272;v=A57uK8L9cJNPW6T3F90-FRIa7z_gX2LZ9CMWvUgnCuHcazBlsO-y6cSzZswb',
            'Host': 'q.10jqka.com.cn',
            'Referer': 'http://q.10jqka.com.cn//index/index/board/all/field/zdf/order/desc/page/1/ajax/1/',
